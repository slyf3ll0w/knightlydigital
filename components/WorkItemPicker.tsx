  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && matches.length > 0 && (
        <div className="ds-glass absolute left-0 right-0 sm:right-auto sm:w-80 sm:max-w-[calc(100vw-2rem)] top-full mt-1 z-40 rounded-xl py-1 max-h-72 overflow-y-auto">
          {matches.map((item, i) => (
            <button
              key={item.id}
              type="button"
