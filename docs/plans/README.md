...
## In flight / next up
- `pricing-plans-2026-09-25.md` — **DECIDED, site + whitelist BUILT 2026-09-25**: Bench (free, 2 users, $10/seat) + Dispatch $25 (phone line, $25 setup, 500 texts/500 min) + Shop $89 (unlimited users + ops tools) + Jobsite $29 (photos, coming soon) + Full Shop $99 now / $119 later; `lib/plans.ts` catalog, superadmin plan whitelist; NOT done: Shop gating, Shop/Full Shop checkout, usage billing.
