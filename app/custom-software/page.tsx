...
const svc = getServiceBySlug("custom-software")!;
    ...
    <>
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 pb-20 w-full">
          ...
          <h1 className="text-4xl lg:text-6xl font-black uppercase text-white leading-tight max-w-3xl mb-4">
            {svc.name}
          </h1>
      ...
      <section className="bg-primary text-primary-foreground border-b border-primary-foreground/10">
        <div className="max-w-7xl mx-auto px-5 py-6 grid sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-primary-foreground/10">
          {[
            { label: "Timeline", value: "Built around your schedule" },
            { label: "Ownership", value: "You own the code — always" },
            { label: "Support", value: "Ongoing management included" },
          ].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-5 grid lg:grid-cols-3 gap-12">
          ...
          <div>
            <div className="bg-primary text-primary-foreground p-8 mb-6">
              ...
              <p className="text-sm text-primary-foreground/60 mb-7">Talk to us about custom software for your business.</p>
