...
const rows: CompareRow[] = [
  ...
  {
    label: "AI assistant",
    workbench: "Atlas — schedules, quotes, invoices, and messages on request, always with a confirmation step. 10,000 free tokens every month; Atlas Full is $20/month for 150,000.",
