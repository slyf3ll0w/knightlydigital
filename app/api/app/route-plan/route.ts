 ...
 * through lib/route-plan.ts. Role scoping matches the schedule: techs get
 * their assigned jobs only, sales their leads', managers/USER everything.
 * Tech filtering happens client-side — the whole day is one payload.
 */
