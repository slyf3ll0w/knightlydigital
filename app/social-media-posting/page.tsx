...
const svc = getServiceBySlug("social-media-posting")!;
const otherServices = services.filter((s) => s.slug !== svc.slug);

export const metadata: Metadata = {
  title: `Social Media Management | Allen, TX | Streamflare Media Group`,
    ...
    <>
      ...
      <section className="bg-primary text-primary-foreground border-b border-primary-foreground/10">
        <div className="max-w-7xl mx-auto px-5 py-6 grid sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-primary-foreground/10">
          {[
            { label: "Content", value: "Professional, on-brand graphics" },
            { label: "Consistency", value: "Scheduled posting pipeline" },
            { label: "Strategy", value: "Built around your customer profile" },
          ].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-5 grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground leading-relaxed mb-12">
              Consistency is the foundation of a strong social presence. Businesses that post professionally and on-brand build trust over time — and that trust converts to customers. We handle the full content pipeline so your team can stay focused on operations.
            </p>
          ...
          <div>
            <div className="bg-primary text-primary-foreground p-8 mb-6">
              ...
              <p className="text-sm text-primary-foreground/60 mb-7">Talk to us about social media for your business.</p>
