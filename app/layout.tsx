...
var L=["/quote","/pay","/portal","/contract","/hub","/book","/embed","/app/register","/app/get-started","/app/login","/app/forgot-password","/app/activate","/reset-password","/verify-email","/superadmin/login"];
...
new MutationObserver(function(){if(!document.documentElement.dataset.mode)apply();}).observe(document.documentElement,{attributes:true,attributeFilter:["data-mode"]});
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Lexend:wght@300..800&family=Oxanium:wght@400;500;600;700;800;900&family=Inter:wght@400;500;600;700&family=Nunito:wght@700;800&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
